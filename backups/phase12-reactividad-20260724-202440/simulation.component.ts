  ...
  template: `
    <section class="page">
      ...
      <div class="zone-tabs" role="tablist" aria-label="Zona de clasificación">
        <button [class.active]="zone === 'title'" (click)="zone = 'title'">Campeón</button>
        <button [class.active]="zone === 'top4'" (click)="zone = 'top4'">Top 4</button>
        <button [class.active]="zone === 'europe'" (click)="zone = 'europe'">Top 7</button>
        <button [class.active]="zone === 'relegation'" (click)="zone = 'relegation'">Descenso</button>
      </div>
